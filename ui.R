#library(shiny)
#setwd("/Users/ms/Dropbox/RCode/Shiny/")
#runApp("Boxplot.shiny/")
#includeHTML('<script src="js/clearTextField.js"></script>')

#HTML('function eraseText() { document.getElementById("output").value = "";}')
...
#						numericInput("meanCI", "Define confidence interval of means:", min=50, max=100, step=0.5, value=95)
...
# http://www.iric.ca/en/research/principal-investigators/michael-tyers/
