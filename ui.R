shinyUI(fluidPage(
    ...
    tags$head(
        tags$style(HTML("
			...
			textarea { width: 100%; max-width: 100%; display: block; border-radius: 6px; border: 1px solid #d1d5db; box-sizing: border-box; margin-bottom: 10px; font-family: 'Courier New', Courier, monospace; white-space: pre; overflow-x: auto; }
        ...
        mainPanel(
            tabsetPanel(
				...
				<p>BoxPlotR code can be run locally via <a href="https://github.com/jwildenhain/BoxPlotR.shiny/blob/master/README.md">GitHub</a>. You can also download and install it as a virtual machine (see <a href="https://github.com/jwildenhain/BoxPlotR.shiny/blob/master/README.md">GitHub</a> and FAQs for details). </p>'),
                    h5("Support BoxPlotR"),
                    HTML('<p>Please consider supporting the development and maintenance of BoxPlotR with a <a href="https://www.paypal.com/pools/c/9oezkBOeV3" target="_blank">donation</a>.</p>'),
				...
				Neuwirth, E. <i><a href="http://cran.r-project.org/web/packages/RColorBrewer/index.html">RColorBrewer</a>: ColorBrewer palettes.</i> R package version 1.0-5. (2011)</p>'),
                    ...
                    h6(
                        "This application was created by the ", a("Tyers", href = "http://tyers.iric.ca/"), " and ", a("Rappsilber", href = "http://rappsilberlab.org/"),
                ...
                # Data upload tab
                tabPanel(
                    "Data upload", tableOutput("filetable"),
                    h6(
                        "This application was created by the ", a("Tyers", href = "http://tyers.iric.ca/"), " and ", a("Rappsilber", href = "http://rappsilberlab.org/"),
                        " labs. Please send bugs and feature requests to Michaela Spitzer (michaela.spitzer(at)gmail.com) and Jan Wildenhain (jan.wildenhain(at)gmail.com). This application uses the ",
                        a("shiny package from RStudio", href = "http://www.rstudio.com/shiny/"), "."
                ...
                # Figure legend
                tabPanel(
                    "Figure legend template", h5("Box plot description for figure legend:"), textOutput("FigureLegend"),
                ...
                tabPanel(
                    "News",
                    h5("April 16, 2026"),
                    HTML("<p>The number of concurrent sessions has been increased to 50.</p>"),
                    h5("April 8, 2026"),
